...
<head>
	...
	<title>OEROWEB - Acceso Restringido</title>
...
<body>
	...
	<div id="jail">
		...
		<!-- thank you https://stackoverflow.com/posts/15496546/revisions -->
			...
			<text x="0" y="0" text-anchor="left" style="font-size:90pt;"><textPath xlink:href="#textPath" startOffset="0%" >OeroWeb</textPath><textPath xlink:href="#textPath" startOffset="50%" >OeroWeb</textPath></text>
		</svg>
		<div id="cursor"></div>
	</div>
